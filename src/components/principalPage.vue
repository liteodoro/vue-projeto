         ...
         <div class="btnVoltar">
            <a href="principalPage.vue"><i class="bi bi-arrow-up-circle"></i></a>
              ...
              <div class="container">
                ...
                <section id="propaganda3" class="container text-center text-white bg-orangered">
                                ...
                                <div class="row">
                                  <div class="col-md-4 col-12">
                                    <div class="text-start p-2">
                                      ...
                                      <p><i class="bi bi-envelope p-1"></i>Sac@costeladeadaomodas.com.br</p>
                                    </div>
                                  ...
                                  <div class="col-md-4 col-12 p-5">
                                    ...
                                    <div class="input-group flex-nowrap">
                                      ...
                                      <button type="button" class="btn btn-success form-control">Enviar</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
...
<style scoped>
    .imgBG1 { background-image: url(@/assets/imagens/homfig1.jpg);}
    .imgBG2 { background-image: url(@/assets/imagens/promocaoblackf.png);}
    .imgBG3 { background-image: url(@/assets/imagens/acessorios.jpg);}
    .imgBG4 { background-image: url(@/assets/imagens/girl1.jpg);}
    .imgBG5 { background-image: url(@/assets/imagens/homfig2.jpg);}
    .size{
        max-width: 700px;
        min-height: 700px;
    }
