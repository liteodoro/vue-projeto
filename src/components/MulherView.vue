            ...
            <div class="col-6">
              <div class="">
                <a href="produto-detalhe.html" target="_blank">
                  <button type="button" class="col-12 bg-yellow">
                    Comprar
                  </button>
                </a>
              </div>
    ...
    <section
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body text-black">
              ...
              <p class="card-text">
                Chapéu Vintage Moda Panamá Palha Shantung.
              </p>
            </div>
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text text-black">
                Cabe tudo: as suas companheiras de rotina. Entre os modelos de
                bolsas que vão e voltam, estão as bolsas da moda
              </p>
            </div>
            <div class="card-footer">
              <small class="text-muted"
        ...
        <div class="col">
          <div class="card h-100">
            <img
              src="@/assets/imagens/acessorios.jpg"
              class="card-img-top"
              alt="sugestao1"
            />
            <div class="card-body text-black">
              ...
              <p class="card-text text-black">
                óculos e outros acessórios pra completar seu look.
              </p>
            </div>
            <div class="card-footer">
              <small class="text-muted"
